...
?>
  ...
  <section class="estrutura-produto">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <h3>2016 to Become a Breakthrough Year for Fuel Cell Electric</h3>
          <p class="mb-5"><strong>Ref.: </strong>0000000</p>
          <p class="mb-5"><strong>Estrutura: </strong></p>
          <p class="mb-5"><strong>Frente: </strong>vidro temperado e de baixa reflexão, 3,2 mm</p>
          <p class="mb-5"><strong>Célula: </strong>72 Células de silico policristalino de alta potência 156mm x 156mm</p>
          <p class="mb-5"><strong>Verso: </strong>película posterior resistente ás intempéries (branca)</p>
          <p class="mb-5"><strong>Moldura: </strong>35mm moldura de alumínio (cor de prata, anodizado)</p>
          <p class="mb-5"><strong>Medida: </strong>1954mm x 992mm x 35 mm</p>
